...
install -Dm644 /usr/lib64/icecat-52.1.0/defaults/extensions.ini $PROFDIR/icecat/extensions.ini
install -Dm644 /usr/lib64/icecat-52.1.0/defaults/user.js $PROFDIR/icecat/user.js
